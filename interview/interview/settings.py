...
SECRET_KEY = 'django-insecure-1e*9pjb8td3p5&ov*s=bgfl^o16kibr5h-4v=&@l*l-@_-&3jw'
...
'django.middleware.common.BrokenLinkEmailsMiddleware',  # 新增这行
]
...
CORS_ALLOW_ALL_ORIGINS = True  # 开发阶段可以开启，生产环境应关闭
